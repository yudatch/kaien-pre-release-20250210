...
import type { Column } from '@/app/types/components/core/table';
import type { Expense } from '@/app/types/api/expenses';
import { EXPENSE_CATEGORY_LABELS, PAYMENT_METHOD_LABELS } from '@/app/constants/expenses';
import { formatCurrency } from '@/app/utils/currency';
import { formatDate } from '@/app/utils/date';

const getStatusColor = (status: Expense['status']): 'default' | 'warning' | 'success' | 'error' | 'info' => {
  switch (status) {
    case 'draft':
      return 'default';
    case '申請中':
